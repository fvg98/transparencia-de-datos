...
#coloresDip=["violet","blueviolet","mediumorchid","darkslateblue"]
coloresDip=["darkslateblue","coral","gold","darkturquoise"]
tituloDip="¿Qué generación controla la Camará de Diputados?"
totalDip=graficaGenPart(tituloDip,coloresDip,"diputadosGenPart")

export_csv = totalDip.to_csv ("Gen2018.csv",index = None, header=True, encoding="utf-8-sig")
